...
from api.pipelines.noon_namshi import run


class Command(BaseCommand):
    help = "Run Noon & Namshi pipeline for a date range"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"🚀 Running Noon & Namshi pipeline {date_from} → {date_to}")
