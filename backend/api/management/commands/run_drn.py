...
from api.pipelines.drnutrition import run


class Command(BaseCommand):
    help = "Run DrNutrition pipeline for a date range"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"🚀 Running DrNutrition pipeline {date_from} → {date_to}")
