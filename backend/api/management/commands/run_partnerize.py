...
from api.pipelines.partnerize import run


class Command(BaseCommand):
    help = "Run Partnerize pipeline for a date range"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"🚀 Running Partnerize pipeline {date_from} → {date_to}")
